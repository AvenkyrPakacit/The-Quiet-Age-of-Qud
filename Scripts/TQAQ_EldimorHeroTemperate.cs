    ...
    public class TQAQ_EldimorHeroTemperate : IObjectBuilder
    {
        ...
        public override void Apply(GameObject GO, string Context)
        {
            ...
            if (!title.IsNullOrEmpty())
            {
                ...
                {
                    GO.BoostStat("Toughness", 3);
                }
                if (title.Contains("Clan Redrock"))
                {
                    GO.BoostStat("Strength", 3);
                    mutations.AddMutation(new World.Parts.Mutation.HeightenedSpeed(), 2);
                }
...
namespace XRL.World.Parts
{
    ...
    public class TQAQ_EldimorHeroDrekirClanTemperate : IPart
    {
        ...
        public bool Created;
        [NonSerialized] public bool HeightenedSpeed;
